    ...
    <div>
      <Grid container>
        <Grid item xs={6} sx={{paddingLeft:"80px",paddingTop:"15px"}}>
           ...
           <img style={{width:"230px"}} src={linkedin}/>
           <h2 style={{fontWeight:"100",fontSize:"60px",color:"orange",fontFamily:"-moz-initial"}}>ConnectSphere</h2>
            <h2 style={{fontWeight:"100",fontSize:"60px",color:"#B26F28"}}>Find jobs Online</h2>
        ...
        <Grid item xs={6}>
           <img style={{width:"680px", height:"300", topmargin:"100"}} src={developer}/>
        </Grid>
      </Grid>
    </div>
  )
